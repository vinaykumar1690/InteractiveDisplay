...
Public displays are ubiquitous. They can be seen in many public locations including malls, schools, and amusement parks. Public displays share these characteristics:
\begin{itemize}
...
\section{Objectives}
The objectives of this project is to make public displays interactive. We narrow down to a scenario, that is a cocktail party where people mostly mingle with others. Specifically, we hope to achieve two goals. First, we would like to encourage interaction between people and display, and also to make displays and people aware of each other's presence. Second, we would like to foster interaction between people and encourage discussion.
...
The objectives of the game are very simple. It allows people to interact with displays and promotes interaction between people quickly. We set up our game in scenario like a cocktail party where people are usually occupied; we want to make sure that players can join the game anytime. Moreover, players shall not feel obligated to stay in the game; he/she should be able to leave the game anytime without affecting other players. 
...
Figure \ref{fig:p_easy_understand} shows the responses for the game Battle of Cities and Figure \ref{fig:t_easy_understand} is the responses for Translator's Dilemma. 
...
The following question we asked participants was, ``Did you discuss with others during the game?''. Figure \ref{fig:p_discuss} shows the responses for the game Battle of Cities and Figure \ref{fig:t_discuss} is the responses for Translator's Dilemma.
...
We asked the participants, ``How did you choose your answer''. Scale 1 denotes completely random answer and 10 for logical answer. Figure \ref{fig:p_random_logical} shows the responses for the game Battle of Cities and Figure \ref{fig:t_random_logical} is the responses for Translator's Dilemma. 
...
The follow up question asked participants, ``How much did the updates sidebar influence your answer?''. Figure \ref{fig:p_influence} shows the responses for the game Battle of Cities and Figure \ref{fig:t_influence} is the responses for Translator's Dilemma.
