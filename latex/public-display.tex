...
Guideline 2: The answers should be correct or logical}
...
\textbf{Do not underestimate the efforts to implement web page on mobile devices}\\
...
\textbf{Public display should be self-configurable}\\
...
\textbf{Long-duration deployment discloses bugs}\\
...
\textbf{Fault-tolerance at public display}\\
...
\textbf{Backend server should be publicly addressable}\\
A common mistake in 
...
\textbf{Provide alternative way to allow players to access the game}\\
...
\textbf{Carefully choose the place to conduct user study}\\
